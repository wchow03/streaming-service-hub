...
export default function Register() {
    ...
    return (
        <>
            {emailRegisteredSuccess && <Alert banner className={"text-center"} message="Account successfully registered" type="success"/>}
            {emailRegisteredError && <Alert banner closable message="Error registering account, email may already be registered" type="error"/>}
