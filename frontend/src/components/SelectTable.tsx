export default function DynamicCreateTable({setRoute} : {setRoute: any}) {
    ...
    return (
        <>
            <label className={`text-xl font-bold text-white pb-10 uppercase`}> Select a Table </label>
            <select id="tables" onChange={handleSelectChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
